...
class _SddsFile(object):
    ...
    def init(self):
        ...
        ListOfKnownBadBpms = ["BPMWC.6L7.B2" ,"BPMR.6L7.B2", "BPMSI.B4L6.B2", "BPMSI.A4L6.B2", "BPMSX.4L2.B2", "BPMS.2L2.B2", "BPMWB.4R8.B1", "BPMS.2L5.B1", 'BPMS.2R5.B1', "BPMSI.A4R6.B1", "BPM.22R8.B1", "BPM.23L6.B1"]
