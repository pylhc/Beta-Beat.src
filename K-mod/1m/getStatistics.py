...
parser.add_option("-m", "--modifiers",
                ...
                metavar="MPATH", default="/afs/cern.ch/eng/sl/lintrack/Beta-Beat.src/K-mod/", dest="mpath")
parser.add_option("-c", "--cpath",
                help="Path to K-mod base source files, default is recommended",
                metavar="CPATH", default="/afs/cern.ch/eng/sl/lintrack/Beta-Beat.src/K-mod/TESTING/", dest="cpath")
