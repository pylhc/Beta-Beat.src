...
class sddsdata(object):
  def __init__(self,filename,endian='little',full=True):
    ...
    #Print "reqding line",self.fh.readline()
    #sys.exit()
  ...
  #Before d=n.array(mysplit(self.fh,cnt),typ).reshape(dims)
		...
		#print  "check this ",i
	        ...
	        i['value']=d[0] # change		
                ...
                if typ=='string':  #### this is for the bpms
                  d=[]
		  smax=0
...
#       
 ...
 #### F.R. 30-06-09
  def treat_header(self):
    ...
    for line in lines:
      #print "ddddddddddd ",line
      if line['header']=='&parameter':
        name  = line['name']
        type  = line['type']
        #print "hereeeeeeeeeeeeeeeee"
        value = line['value'] #this should be acitvated again
