...
parser.add_option("-a", "--accel",
                ...
                metavar="accel", default="SOEIL",dest="accel")
...
def madcreator(inifile,madfile,dpps):
	...
	linesmad=open(madfile+"/soleilinput_chroma.madx","r").readlines()
...
madcreator(outputpath+"/super.ini",options.brc+"/SOLEIL/source_2011/chroma/",dpplist)
