...
class TestCorrectChromCoup(unittest.TestCase):
    ...
    def setUp(self):
        self._run_dirs = utils.iotools.get_all_dir_names_in_dir(TestCorrectChromCoup.PATH_TO_INPUT)
    ...
    def _valid_output_exists(self):
        all_dirs = utils.iotools.get_all_dir_names_in_dir(TestCorrectChromCoup.PATH_TO_VALID)
    ...
    def _delete_output(self):
        if _DELETE_VALID_OUTPUT:
            utils.iotools.delete_content_of_dir(TestCorrectChromCoup.PATH_TO_VALID)
        self._delete_modified_output()

    def _delete_modified_output(self):
        ''' Deletes content in PATH_TO_TO_CHECK. '''
        utils.iotools.delete_content_of_dir(TestCorrectChromCoup.PATH_TO_TO_CHECK)
    ...
    def _compare_output_dirs(self, run_dir):
        ...
        self.assertTrue(
                        utils.ndiff.compare_dirs_with_files_matching_regex_list(valid_dir, to_check_dir, file_to_config_file_dict=dict_file_to_config_file),
