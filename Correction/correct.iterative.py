...
FullResponse=pickle.load(open(accelpath+'/MODEL/'+options.ACCEL+'/FullResponse.Numeric','r'))
print "Loading ended"
...
execfile(accelpath+'/MODEL/'+options.ACCEL+'/AllLists_old.py')
exec('varslist=vars'+options.ACCEL+'()')
...
#    print deltas
#    if "LHC" in options.ACCEL :   # Only for LHC?
