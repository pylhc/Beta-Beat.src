...
c      COMPLEX*16 ZSING(MAXITER)
      COMPLEX ZSING(MAXITER)
      DIMENSION X(MAXITER),XP(MAXITER)
      DIMENSION Z(MAXITER)
C.............................................................
      ZU=DCMPLX(0D0,1D0)
...
C.............................................................
      ...
      DO MF=1,NPOINT
c        Z(MF)=DCMPLX(X(MF),XP(MF))
        Z(MF)=CMPLX(X(MF),XP(MF))
        ZSING(MF)=Z(MF)
        SUM=SUM+XP(MF)
      ENDDO 
c      CALL FFT(ZSING,NPOINT,-1)
      CALL CFFT(ZSING,-MFT)
...
C........................................FINAL INTERPOLATION
      ...
      IF (DABS(TUNEABT).GT.0.5D0) 
     .                   TUNEABT=TUNEABT-DSIGN(1.0D0,TUNEABT)
C............................................................  
...
C.............................................................
      SUM=0D0            !..CHECKS FOR COMPLEX OR REAL DATA
      DO MF=1,NPOINT
c        Z(MF)=DCMPLX(X(MF),XP(MF))*DSIN(STEP*MF)**2
        Z(MF)=CMPLX(X(MF),XP(MF))*SIN(STEP*MF)**2
        ZSING(MF)=Z(MF)
        SUM=SUM+XP(MF)
      ENDDO 
c      CALL FFT(ZSING,NPOINT,-1)
...
C........................................FINAL INTERPOLATION
      ...
      IF (DABS(TUNEABT2).GT.0.5D0) 
     .                TUNEABT2=TUNEABT2-DSIGN(1.0D0,TUNEABT2)
C............................................................  
