...
#datab1 = twiss('Beam1/sbs/twiss_IP8.dat')
...
#betafreedataxb1 = twiss('Beam1/getbetax_free.out');
#betafreedataxb2 = twiss('Beam1/getbetax_free.out');
#
#print 'getbetafreex B1 Q1 = ',betafreedataxb1.Q1
#print 'getbetafreex B1 Q2 = ',betafreedataxb1.Q2
#print 'getbetafreex B2 Q1 = ',betafreedataxb2.Q1
#print 'getbetafreex B2 Q2 = ',betafreedataxb2.Q2
#
#B1QX = betafreedataxb1.Q1;
#B1QY = betafreedataxb1.Q2;
#B2QX = betafreedataxb2.Q1;
#B2QY = betafreedataxb2.Q2;
#
#
#betadataxb1 = twiss('Beam1/getbetax.out');
#betadataxb2 = twiss('Beam1/getbetax.out');
#
#print 'getbetax B1 Q1 = ',betadataxb1.Q1
#print 'getbetax B1 Q2 = ',betadataxb1.Q2
#print 'getbetax B2 Q1 = ',betadataxb2.Q1
#print 'getbetax B2 Q2 = ',betadataxb2.Q2
#
#B1QX = betadataxb1.Q1;
#B1QY = betadataxb1.Q2;
#B2QX = betadataxb2.Q1;
...
for name in dataxb1.NAME:
  w = 1;
#  if (dataxb2.ERRORX[i] > 1e-8 ):
#    w=0.001/(dataxb2.ERRORX[i]*dataxb2.ERRORX[i]);
...
#  if (dataxb2.ERRORX[i] > 1e-8 ):
#    w=0.001/(dataxb2.ERRORX[i]*datayb2.ERRORX[i]);
