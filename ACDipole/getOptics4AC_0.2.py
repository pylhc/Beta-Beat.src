...
def dosub(plane,real,model):
	...
	for bpm in bpms:
		...
		if plane=="H":
			...
			errbet=(sqrt(real.ERRBETX[real.indx[bpm]]**2+real.STDBETX[real.indx[bpm]]**2))/model.BETX[model.indx[bpm]]
			...
			beta=(beta_real-beta_model)/beta_model
			alfa=alfa_real-alfa_model
			errbet=((real.ERRBETY[real.indx[bpm]]**2+real.STDBETY[real.indx[bpm]]**2))/model.BETY[model.indx[bpm]]
			phase=0

		data[bpm]=[bpm,s,beta,alfa,phase,errbet]
...
print >> betaxac_mo, "* NAME S BETAX ALFAX PHASEX BETAXM ALFAXM PHASEXM PHASED ERRBETAX"
print >> betaxac_mo, "$ %s   %le %le %le %le %le %le %le %le %le"

print >> betayac_mo, "* NAME S BETAY ALFAY PHASEY BETAYM ALFAYM PHASEYM PHASED ERRBETAY"
print >> betayac_mo, "$ %s   %le %le %le %le %le %le %le %le %le"
...
for bpm in bpms:
  ...
  #  phase=getphase(sign,lambdadx,phasebpm*2*pi,phaseac*2*pi,drivenphasex,drivetunex)
   ...
   # print >> betaxac, bpm[1], bpm[0],beta, alfa, phase,betam,alfam,phasem,drivenphasex
    print >> betaxac_mo, data_hor[1][bpm[1]][0], data_hor[1][bpm[1]][1], data_hor[1][bpm[1]][2],  data_hor[1][bpm[1]][3],  data_hor[1][bpm[1]][4],0,0,0,0, data_hor[1][bpm[1]][5]
 ...
 #   phasem=model.ALFY[model.indx[bpm[1]]]
  ...
  #  vertical=[bpm, beta,alfa,phase,betam,alfam,phasem,drivenphasey]
   ...
   # print >> betayac, bpm[1], bpm[0],beta, alfa, phase,betam,alfam,phasem,drivenphasey
    print >> betayac_mo,data_ver[1][bpm[1]][0], data_ver[1][bpm[1]][1],data_ver[1][bpm[1]][2], data_ver[1][bpm[1]][3], data_ver[1][bpm[1]][4],0,0,0,0,data_ver[1][bpm[1]][5]
