...
class TestGetFilenamesInDir(unittest.TestCase):
    ...
    def test_filenames(self):
        received_all_abs_filenames = Utilities.iotools.get_all_absolute_filenames_in_dir_and_subdirs(self.__abs_path_to_root)
        ...
        received_filenames = Utilities.iotools.get_all_filenames_in_dir_and_subdirs(self.__abs_path_to_root)
