...
def write_beta_beat(element_name,
    ...
    _write_beta_beat_from_phase_for_plane(
        file_beta_phase_x, "X", element_name, phase_bpms_list, measured_hor_beta_phase,
        model_propagation, model_cor, model_back_propagation, model_back_cor,
        save_path)
    _write_beta_beat_from_phase_for_plane(
        file_beta_phase_y, "Y", element_name, phase_bpms_list, measured_ver_beta_phase,
        model_propagation, model_cor, model_back_propagation, model_back_cor,
        save_path)

    if measured_hor_beta_amp is not None and measured_ver_beta_amp:
        amp_bpms_list = intersect([model_cor, model_propagation,
                                   model_back_propagation, model_back_cor,
                                   measured_hor_beta_amp, measured_ver_beta_amp])
        _write_beta_beat_from_amp_for_plane(
            file_beta_amp_x, "X", element_name, amp_bpms_list, measured_hor_beta_amp,
            model_propagation, model_cor, model_back_propagation, model_back_cor,
            save_path)
        _write_beta_beat_from_amp_for_plane(
            file_beta_amp_y, "Y", element_name, amp_bpms_list, measured_ver_beta_amp,
            model_propagation, model_cor, model_back_propagation, model_back_cor,
            save_path)
...
def _write_beta_beat_from_phase_for_plane(file_beta_beat, plane, element_name, bpms_list,
...
def _write_beta_beat_from_amp_for_plane(file_beta_beat, plane, element_name, bpms_list,
