...
for i in range(0,len(bpms.NAME1)):
  ...
  print >>out2x, resIPx[i][0],resIPx[i][1],round(resIPx[i][2],3),round(resIPx[i][3],3),round(resIPx[i][4],3),  round((resIPx[i][4]-resIPx[i][2])*1000,1), round(resIPx[i][3]*1000,1)

for i in range(0,len(bpms.NAME1)):
  resIPy[i]=phasediffy(ty.indx[bpms.NAME1[i]+'.'+b],ty.indx[bpms.NAME2[i]+'.'+b])
  print >>out2y, resIPy[i][0],resIPy[i][1],round(resIPy[i][2],3),round(resIPy[i][3],3),round(resIPy[i][4],3),  round((resIPy[i][4]-resIPy[i][2])*1000,1), round(resIPy[i][3]*1000,1)
