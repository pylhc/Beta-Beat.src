...
def calculate_phase(getllm_d, twiss_d, tune_d, mad_twiss, mad_ac, mad_elem, files_dict):
    ...
    if getllm_d.with_ac_calc:
        if twiss_d.has_zero_dpp_x():
            ...
            [phase_d.x_f, tune_d.muxf, bpmsxf, phase_d.lambda_r] = compensate_ac_effect.get_free_phase_eq(mad_twiss, twiss_d.zero_dpp_x, tune_d.q1, tune_d.q1f, phase_d.acphasex_ac2bpmac, 'H',
        ...
        if twiss_d.has_zero_dpp_y():
            ...
            [phase_d.y_f, tune_d.muyf, bpmsyf, phase_d.lambda_r] = compensate_ac_effect.get_free_phase_eq(mad_twiss, twiss_d.zero_dpp_y, tune_d.q2, tune_d.q2f, phase_d.acphasey_ac2bpmac, 'V',
