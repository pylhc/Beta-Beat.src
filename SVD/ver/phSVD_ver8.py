...
#--- contains some ugly patch for CTF3 stuff, but fixed properly
in the next ver
import sys,os,re
try:
    from numpy import *; svd=linalg.svd; rfft=fft.rfft
    ...
    try:
        from Numeric import *; from FFT import fft as rfft 
...
if __name__ == "__main__":
    ...
    try:
        ...
        TUNEX, TUNEY=zeros(100), zeros(100)
        print "Awful patch to avoid error in Sussix"
