...
python GetLLM/GetLLM.py --accel=LHCB1 --model=${modelDir}/twiss.dat --files=${measDir}/Beam1@Turn@2017_08_18@09_59_41_414.sdds.clean.new --analyse=sussix --output=$resultDir --tbtana=SUSSIX --bpmu=mm --lhcphase=1 --errordefs=$modelDir /error_deff.txt
