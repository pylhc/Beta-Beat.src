...
do
    ...
    cp job.Beam1.ACdipoletracking.6500GEV.40cm.madx DetuningWithAmplitude_horizontal/Amplitude_$amp/job.$amp.mask 
...
do
    ...
    cp job.Beam1.ACdipoletracking.6500GEV.40cm.madx DetuningWithAmplitude_vertical/Amplitude_$amp/job.$amp.mask 
